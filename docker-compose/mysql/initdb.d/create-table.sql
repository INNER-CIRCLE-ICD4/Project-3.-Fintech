...
(
    ...
    send_user_id           BIGINT      NOT NULL COMMENT "송금자 ID",
    send_account_number    VARCHAR(13) NOT NULL COMMENT "송금 계좌 번호",
    receive_phone_number   VARCHAR(20) NULL COMMENT "수취자 휴대폰 번호",
    receive_account_number VARCHAR(13) NULL COMMENT "수취자 계좌 번호",
