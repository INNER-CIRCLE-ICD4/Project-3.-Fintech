package com.sendy.sendyLegacyApi.application.usecase.authorities // package com.sendy.application.usecase.auth
//
...
// import com.sendy.sendyLegacyApi.application.usecase.auth.interfaces.*
...
//
//        // Mock 설정
//        `when`(verifyUserCredentials.execute(loginRequestDto.id, loginRequestDto.password))
//            .thenReturn(user)
...
//        verify(verifyUserCredentials).execute(loginRequestDto.id, loginRequestDto.password)
...
//
//        inOrder.verify(verifyUserCredentials).execute(loginRequestDto.id, loginRequestDto.password)
