...
import com.sendy.application.usecase.auth.interfaces.InvalidateExistingTokensUseCase
import com.sendy.domain.auth.token.service.JwtTokenStorageService
import org.slf4j.LoggerFactory
import org.springframework.stereotype.Service

@Service
class InvalidateExistingTokensUseCaseImpl(
    private val jwtTokenStorageService: JwtTokenStorageService,
) : InvalidateExistingTokensUseCase {
    
    private val logger = LoggerFactory.getLogger(InvalidateExistingTokensUseCaseImpl::class.java)
