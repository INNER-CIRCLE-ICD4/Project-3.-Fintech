...
import com.sendy.application.usecase.user.UserService
...
class UserController(
    ...
    ): ResponseEntity<RegisterUserResponseDto> = ResponseEntity(UserService.registerUser(requestDto), HttpStatus.OK)
    ...
    fun authEmailSent(email: String): ResponseEntity<String> = ResponseEntity(UserService.sendVerificationEmail(email), HttpStatus.OK)
    ...
    fun authEmailVerify(
        email: String,
        emailCode: String,
    ): ResponseEntity<String> = ResponseEntity(UserService.verifyEmail(email, emailCode), HttpStatus.OK)
}
