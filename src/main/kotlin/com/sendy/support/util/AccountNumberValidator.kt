...
object AccountNumberValidator {
    ...
    fun formatWithHyphens(accountNumber: String): String {
        ...
        return "${accountNumber.substring(0, 3)}-${accountNumber.substring(3, 7)}-${accountNumber.substring(7, 9)}-${accountNumber.substring(9, 13)}"
    }
     ...
     */
    fun removeHyphens(formattedAccountNumber: String): String {
